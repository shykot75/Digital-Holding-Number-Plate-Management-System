...
@section('title')
    ওয়ার্ড সম্পাদন | ডিজিটাল হোল্ডিং নাম্বার প্লেট ম্যানেজমেন্ট সিস্টেম
@endsection
...
@section('body')
    ...
    <section class="tax-add px-3" >
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="bg-primary text-white py-2 px-3 mb-4">ওয়ার্ড সম্পাদন করুন</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 " >
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <span class="font-size-10">বাংলায় লিখুন, <span class="text-danger">উদাঃ লক্ষ্মীপুর পৌরসভা-০১</span></span>
                                        <input type="text" name="ward_name" class="form-control" id="ward_name" placeholder="ওয়ার্ড নাম" required value="{{$ward->ward_name}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="ward_no" min="1" class="form-control" id="ward_no" placeholder="ওয়ার্ড নং" required value="{{$ward->ward_no}}">
                                    </div>
                                </div>
