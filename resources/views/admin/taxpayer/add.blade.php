...
@section('title')
    টাক্সদাতা সংরক্ষন | ডিজিটাল হোল্ডিং নাম্বার প্লেট সফটওয়্যার সিস্টেম
@endsection
...
@section('body')
     ...
     <section class="tax-add px-3" >
         <div class="container-fluid">
             <div class="row">
                 <div class="col-md-12">
                     <h4 class="bg-primary text-white py-2 px-3 mb-4">টাক্সদাতা সংরক্ষন করুন</h4>
                     ...
                     <form action="{{route('taxpayer.new')}}" method="POST" enctype="multipart/form-data">
                         @csrf
                         <div class="row">
                             ...
                             <div class="col-md-6 first-half" >
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <input type="text" name="house_name" class="form-control" id="house_name" placeholder="বাড়ির নাম" required>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <input type="text" name="house_owner" class="form-control" id="house_owner" placeholder="হোল্ডিং মালিকের নাম" required>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <input type="text" name="profession" class="form-control" id="profession" placeholder="পেশা">
                                     </div>
                                 </div>

                                  <div class="form-group row mb-4">
                                     <label for="road_name" class="col-md-3 col-form-label">রাস্তার/মহল্লার নাম<span class="text-danger">*</span></label>
                                     <div class="col-md-9">
                                         <input type="text" name="road_name" class="form-control" id="road_name" placeholder="রাস্তার/মহল্লার নাম" required>
                                     </div>
                                 </div>

                                 <div class="form-group row mb-4">
                                     <label for="present_address" class="col-md-3 col-form-label">বর্তমান ঠিকানা<span class="text-danger">*</span></label>
                                     <div class="col-md-9">
                                         <textarea type="text" name="present_address" class="form-control" id="present_address" placeholder="বর্তমান ঠিকানা" required></textarea>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <span class="font-size-11">বাংলায় লিখুন, <span class="text-danger">উদাঃ ৫তলা/সেমিপাকা/১৪ শতাংশ</span></span>
                                         <textarea type="text" name="land_quantity" class="form-control" id="land_quantity" placeholder="ইমারত/ভবনের ধরণ/জমির পরিমান"></textarea>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <textarea type="text" name="non_taxable_part" class="form-control" id="non_taxable_part" placeholder="ট্যাক্স অযোগ্য অংশ (যদি থাকে) ও কারণ"></textarea>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" min="0" name="men_number" id="men_number" class="form-control f-number boy-number family-member" required>
                                            </div>
                                            <label for="" class="col-md-2 col-form-label">(+)</label>

                                            <label for="women_number" class="col-md-2 col-form-label">মহিলা:</label>
                                            <div class="col-md-3">
                                                <input type="number" min="0" name="women_number" id="women_number" class="form-control f-number girl-number family-member" required>
                                            </div>
                                        </div>
                                     </div>
                                     ...
                                     <div class="col-md-9">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-3">
                                                 <input type="number" min="0" name="other_number" id="other_number" class="form-control f-number other-number family-member" >
                                             </div>
                                             <label for="" class="col-md-2 col-form-label">(=)</label>
...
{{--                                                 <input type="text" min="0" id="f-total" class="form-control bg-soft-secondary"  readonly>--}}
                                                 <output min="0" id="f-total" class="form-control bg-soft-secondary total-member" ></output>
                                             </div>
                                         </div>
                                     </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-3">
                                                 <input type="number" min="0" name="child_number" id="child_number" class="form-control fd-number child-number member-desc" >
                                             </div>
                                             <label for="" class="col-md-2 col-form-label">(+)</label>

                                             <label for="disabled_number" class="col-md-2 col-form-label">প্রতিবন্ধী:</label>
                                             <div class="col-md-3">
                                                 <input type="number" min="0" name="disabled_number" id="disabled_number" class="form-control fd-number disabled-number member-desc" >
                                             </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-9">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-3">
                                                 <input type="number" min="0" name="employee_number" id="employee_number" class="form-control fd-number employee-number member-desc" >
                                             </div>
                                             <label for="" class="col-md-2 col-form-label">(+)</label>

                                             <label for="unemployee_number" class="col-md-2 col-form-label">কর্মহীন:</label>
                                             <div class="col-md-3">
                                                 <input type="number" min="0" name="unemployee_number" id="unemployee_number" class="form-control fd-number unemployed-number member-desc" >
                                             </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-9">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-3">
                                                 <input type="number" min="0" name="govt_benefi_number" id="govt_benefi_number" class="form-control fd-number govt-benefi-number member-desc" >
                                             </div>
                                             <label for="" class="col-md-2 col-form-label">(+)</label>

                                             <label for="hw_number" class="col-md-2 col-form-label">গৃহিণী/অন্যান্য:</label>
                                             <div class="col-md-3">
                                                 <input type="number" min="0" name="hw_number" id="hw_number" class="form-control fd-number others member-desc" >
                                             </div>
                                         </div>
                                     </div>
...
{{--                                                 <input type="number" min="0"  id="" class="form-control bg-soft-secondary  " readonly>--}}
                                                 <output min="0" id="fd-total" class="form-control bg-soft-secondary total-member-desc" ></output>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                             ...
                             <div class="col-md-6 second-half">
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-4">
                                                 <input type="number" name="water_connection_number" id="water_connection_number" class="form-control" >
                                             </div>

                                             <label for="connection_size" class="col-md-2 col-form-label">সাইজ:</label>
                                             <div class="col-md-4">
                                                 <input type="number" min="0" step=".1" name="connection_size" id="connection_size" class="form-control" >
                                             </div>
                                         </div>
                                     </div>
                                     <label class="col-md-3 col-form-label"></label>
                                     <div class="col-md-9">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-9">
                                                 <input type="number" name="subscribers_number" id="subscribers_number" class="form-control">
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-5">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-2">
                                                 <input type="radio" name="sanitation_faicilities" id="sanitation_faicilitiesy" class="form-control" value="1">
                                             </div>
                                             ...
                                             <div class="col-md-2">
                                                 <input type="radio" name="sanitation_faicilities" id="sanitation_faicilitiesn" class="form-control" value="0">
                                             </div>
                                         </div>
                                     </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-5">
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-2">
                                                 <input type="radio" name="tubewell_facilities" id="tubewell_facilitiesy" class="form-control" value="1">
                                             </div>
                                             ...
                                             <div class="col-md-2">
                                                 <input type="radio" name="tubewell_facilities" id="tubewell_facilitiesn" class="form-control" value="0">
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-md-2"></div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         ...
                                         <input type="text" name="fiscal_period" class="form-control" id="fiscal_period" value="2021-2022" required>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         ...
                                         <input type="text" name="effective_date" class="form-control" id="effective_date" value="01-07-2021" required>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <input type="number"  max="99999999999" name="mobile_number" class="form-control" id="mobile_number"  required>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <input type="number" max="99999999999999999" name="nid" class="form-control" id="nid"  required>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <span class="font-size-11">বাংলায় লিখুন, <span class="text-danger">উদাঃ ১৩৩/১</span></span>
                                         <input type="text" name="holding_no" class="form-control" id="holding_no" placeholder="হোল্ডিং নং" required>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <select name="category" class="form-control " data-size="10" data-live-search="true" data-style="btn-white">
                                             ...
                                             <option value="4">আবাসিক</option>
                                             <option value="5">বাণিজ্যিক</option>
                                             <option value="1">সরকারি প্রতিষ্ঠান</option>
                                             <option value="6">মিশ্র প্রতিষ্ঠান</option>
                                             <option value="2">বেসরকারি প্রতিষ্ঠান</option>
                                             <option value="3">দাতব্য প্রতিষ্ঠান</option>
                                         </select>
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <input type="number" name="estimated_price" class="form-control" id="estimated_price" placeholder="আনুমানিক গৃহের মূল্য" >
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row mb-4">
                                     ...
                                     <div class="col-md-9">
                                         <span class="font-size-11">বাংলায় লিখুন, <span class="text-danger">উদাঃ ৫৩৪</span></span>
                                         <input type="text" name="plate_no" class="form-control" id="plate_no" placeholder="প্লেট নং" required>
                                     </div>
                                 </div>
